...
export class Permission {
  ...
  @Column({ name: 'CAN_VIEW_LOCAL_ECONOMIC_ENTERPRISE', default: false, nullable: true  })
  canViewLocalEconomicEnterprise: boolean;

  @Column({ name: 'CAN_VIEW_MUNICIPAL_TREASURER', default: false, nullable: true  })
  ...
  // action columns
  @Column({ name: 'ACTION_LOCAL_ECONOMIC_ENTERPRISE', type: 'text', nullable: true  })
